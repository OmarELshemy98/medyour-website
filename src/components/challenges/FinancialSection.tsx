      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="w-full flex justify-center relative">
          <div className="w-full max-w-[220px]">
            ...
            />
            {/* Left side square */}
            <div className="absolute -top-2 -left-2.5 w-8 h-8 bg-[#8CE2FF] animate-float opacity-80"></div>
            
            {/* Bottom square */}
            <div className="absolute -bottom-3 left-12 w-6 h-6 bg-[#00FBFF] animate-float blur-[2px] opacity-80"></div>
            
            {/* Right side square */}
            <div className="absolute top-1/3 -right-0 w-5 h-5 bg-yellow-300 animate-float-delay opacity-80"></div>
          </div>
        </div>
